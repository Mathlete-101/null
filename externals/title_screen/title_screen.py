...
class TitleScreen():
    def __init__(self, size):
        ...
        self.second_options = Selector(["Easy", "Medium", "Hard"], (size[0] / 2, size[1] * 3 / 4))
        ...
        self.instructions.add(WrappedSprite(Text("2. Get here"), fix_units(50, 100)))
        ...
        self.instructions.add(WrappedSprite(Text("and press A to go to the next level."), fix_units(50, 450)))

        self.instructions.add(WrappedSprite(Text("3. If your way is blocked by these"), fix_units(450, 100)))
        self.instructions.add(WrappedSprite(zoom_in(graphics.get("force_field").get()), fix_units(500, 150)))
        self.instructions.add(WrappedSprite(Text("press A to shoot these"), fix_units(450, 300)))
